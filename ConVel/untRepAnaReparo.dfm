object rptAnaReparo: TrptAnaReparo
  Left = 189
  Top = 108
  Width = 601
  Height = 448
  VertScrollBar.Position = 32
  Caption = 'rptAnaReparo'
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    DataSet = sqlReport
    Description.Strings = (
      'Relat'#243'rio Anal'#237'tico de Reparo')
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    ...
    PrintIfEmpty = False
    ReportTitle = 'Relat'#243'rio Anal'#237'tico de Reparo'
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object TitleBand1: TQRBand
      ...
      object QRLabel3: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Relat'#243'rio Anal'#237'tico de Reparo'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
  ...
  object sqlReport: TSQLClientDataSet
    CommandText = 
      ' select v.CODIGOVEICULO, v.DESCRICAO, v.PLACA, r.CODIGOVEICULO, ' +
      'r.CODIGOTIPOREPARO,'#13#10'        r.DATA, r.VALORMAT, r.VALORMAO, r.V' +
      'ALORMAT+ r.VALORMAO as VALORTOTAL, r.HODOMETRO, r.COMPLEMENTO,'#13#10 +
      '        t.CODIGOTIPOREPARO, t.DESCRICAO as DESCREPARO'#13#10' from REP' +
      'ARO r, VEICULO v, TIPOREPARO t'#13#10' where r.CODIGOVEICULO = v.CODIG' +
      'OVEICULO'#13#10'   and r.CODIGOTIPOREPARO = t.CODIGOTIPOREPARO'#13#10#13#10'   o' +
      'rder by CODIGOVEICULO, DATA, t.DESCRICAO'#13#10
    Aggregates = <>
