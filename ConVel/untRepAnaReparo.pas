...
procedure TrptAnaReparo.QRAcum2Print(sender: TObject; var Value: String);
begin
  acumulado := acumulado + sqlReport.FieldByName('VALORTOTAL').AsFloat;
  Value := FloatToStrF(acumulado,ffNumber,8,2);
end;

procedure TrptAnaReparo.QRExpr2Print(sender: TObject; var Value: String);
begin
  acumulado := 0;
end;
