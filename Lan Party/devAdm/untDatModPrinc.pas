...
type
  TdmPrinc = class(TDataModule)
    ...
    sqlLogCODIGOLOJA: TIntegerField;
    sqlLogCODIGOUSUARIO: TIntegerField;
    sqlLogDATA: TDateField;
    sqlLogDESCRICAO: TStringField;
    sqlLogHORA: TTimeField;
    sqlCaixa: TSQLClientDataSet;
    dsCaixa: TDataSource;
    sqlCaixaCONTROLECAIXA: TIntegerField;
    sqlCaixaDATAABERTURA: TDateField;
    sqlCaixaDATAFECHAMENTO: TDateField;
    sqlCaixaHORAABERTURA: TTimeField;
    sqlCaixaHORAFECHAMENTO: TTimeField;
    sqlCaixaSALDOABERTURA: TFloatField;
    sqlCaixaSALDOFECHAMENTO: TFloatField;
  ...
  public
    ...
    procedure Acao(cod_usu: integer; descricao: string);
  end;
...
procedure TdmPrinc.Acao(cod_usu: integer; descricao: string);
begin
  sqlLog.Append;
  sqlLogCODIGOLOJA.AsInteger    := sqlLojaCODIGOLOJA.AsInteger;
  sqlLogCODIGOUSUARIO.AsInteger := cod_usu;
  sqlLogDATA.Value              := Date;
  sqlLogHORA.Value              := Time;
  sqlLogDESCRICAO.AsString      := descricao;
  sqlLog.Post;
  sqlLog.ApplyUpdates(-1);
end;
