<%@ Page Language="c#" Debug="true" Codebehind="nova_tabela.pas" AutoEventWireup="false" Inherits="nova_tabela.TWebForm2"%>
<%@ Register TagPrefix="ajax" Namespace="MagicAjax.UI.Controls" Assembly="MagicAjax" %>


<html><!-- #BeginTemplate "/Templates/Bolao2007.dwt" --><!-- DW6 -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<!-- #BeginEditable "doctitle" -->
<title>Bol&atilde;o 2007</title>
<!-- #EndEditable -->
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    <td height="35" colspan="3" valign="middle" bgcolor="#495e83"> &nbsp; &nbsp; <a href="index.aspx" class="links">P&aacute;gina Inicial</a> 
...
<table width="100%"  border="0" cellspacing="0" cellpadding="5" bgcolor="#FFFFFF">
  <tr> 
    ...
    <form runat="server"><font face="Verdana" size="2">
        <ajax:AjaxPanel id="AjaxPanel1" style="POSITION: relative" runat="server" width="100%" height="84px">
        <table cellspacing="0" cellpadding="0" width="95%" border="1" bordercolor="#495e83" bgcolor="#495e83">
          <tbody>
            <tr>
              <td width="180">
                <p align="right"><font size="2"><font color="#ffffff">Digite
                                 o código da tabela:</font><br></font>
                </p></td>
              <td>
                <p>&nbsp; 
                  <asp:TextBox id="TextBox1" runat="server" columns="2" maxlength="4"
                    borderwidth="1px"></asp:TextBox>
                &nbsp;
                  <asp:TextBox id="TextBox2" runat="server" columns="2" maxlength="4"
                    borderwidth="1px"></asp:TextBox>
                &nbsp;
                  <asp:TextBox id="TextBox3" runat="server" columns="2" maxlength="4"
                    borderwidth="1px"></asp:TextBox>
                &nbsp;
                  <asp:Button id="btnConfirmar" runat="server"
                    text="Confirmar" width="100px" borderwidth="1px"></asp:Button>&nbsp; 
                  <ASP:Button id="btnVoltar" runat="server" text="Voltar" width="100px" borderwidth="1px"></ASP:Button><br>&nbsp; 
                  <asp:Label id="labErro" runat="server" font-size="X-Small"
                    font-bold="True" forecolor="#FFFFC0"></asp:Label>
                </p></td>
            </tr>
          </tbody>
        </table>
  ...
  <tr>
    ...
    <td height="35" align="center" valign="middle" bgcolor="#495e83" class="footer">Copyright 
      &copy; 2007 www.bolao.fot.br - All Rights Reserved. Designed by <a href="http://bublitz.tripod.com/" target="_blank" class="footer">Bublitz.com</a></td>
    <td bgcolor="#495e83" width="20">&nbsp;</td>
  </tr>
</table>
</body>
