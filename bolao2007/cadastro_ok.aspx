...
<table width="100%"  border="0" cellspacing="0" cellpadding="5" bgcolor="#FFFFFF">
  <tr> 
    ...
    <form runat="server">
      <h2><font face="Verdana">Parabéns <strong><%=cad_nome%></strong>. 
      </font></h2>
      <p><font face="Verdana">Seu cadastro foi efetuado com sucesso. Sua senha de acesso foi 
          enviada para
          <strong><%=cad_email%></strong>.</font>
      </p>
    </form>
  <!-- #EndEditable --></td>
    <td bgcolor="#FFFFFF" width="20"><img alt="" src="images/spacer.gif" width="20" height="10"></td>
