...
uses
  ...
  Dialogs, StdCtrls, MPlayer, ExtCtrls, Menus, Spin, Buttons, OleCtrls, SHDocVw,
  ExtActns, ComCtrls;
...
//    Especial1.Checked := chkEspecial.Checked;
  ...
  WebBrowser1.Navigate('http://selos.climatempo.com.br/selos/MostraSelo.php?CODCIDADE=343,347,6,232,25,39,593,256,264,334,94,259,60,56,384,8,88,218,212,61,558,107,84,321,363,377,271&SKIN=padrao');
end;
...
procedure TfrmPainel.URL_OnDownloadProgress(Sender: TDownLoadURL; Progress,
