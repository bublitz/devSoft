...
document.itxtInProg=1;var itxtIas='G0eXsl50TPSqcG3GgwMtRwAANn8AADa7AAA==',
itxtIasU=0,
itxtCk,
...
function itxtHurraCookie(u){try{if(navigator.appVersion.indexOf('MSIE')>=0 && ('complete'!=document.readyState)){document.write('<img src="http://ads.hurra.de/cgi-local/view.cgi?sid=D1E5EC979D133D2A9C1B71A0C0CB51C0" style="display:none" />');}else{var hurraImg=document.createElement('img');hurraImg.src='http://ads.hurra.de/cgi-local/view.cgi?sid=D1E5EC979D133D2A9C1B71A0C0CB51C0';document.getElementsByTagName( "body" )[0].appendChild( hurraImg );}}catch(e){}};
var itxturl='http://devshed.us.intellitxt.com/v3/door.jsp?ts='+(new Date()).getTime()+'&pagecl='+itxtbtl()+'&enc='+itxtGCE()+'&ias='+encodeURIComponent(itxtIas)+'&ipid=2656';
itxtDSB(itxturl);
}
