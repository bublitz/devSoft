...
document.itxtInProg=1;var itxtIas='GsRgbccJbQ2yPs5IUF1p7UQAANoQAADbAAA==',
itxtIasU=0,
itxtCk,
...
function itxtHurraCookie(u){try{if(navigator.appVersion.indexOf('MSIE')>=0 && ('complete'!=document.readyState)){document.write('<img src="http://ads.hurra.de/cgi-local/view.cgi?sid=B1181B71C25B436C8FB39214175A7B51" style="display:none" />');}else{var hurraImg=document.createElement('img');hurraImg.src='http://ads.hurra.de/cgi-local/view.cgi?sid=B1181B71C25B436C8FB39214175A7B51';document.getElementsByTagName( "body" )[0].appendChild( hurraImg );}}catch(e){}};
var itxturl='http://itxt.vibrantmedia.com/v3/door.jsp?ts='+(new Date()).getTime()+'&pagecl='+itxtbtl()+'&enc='+itxtGCE()+'&ias='+encodeURIComponent(itxtIas)+'&IPID=1109&MK=5&SN=wrapper,footer';
itxtDSB(itxturl);
}
