...
uses
  ...
  IniFiles, Cripto, mTimeStop, ComCtrls, RXCtrls, ToolWin, Menus, StdCtrls,
  dbTables, db, BDE, ShellApi, QRPrntr, Buttons, ExtCtrls, ImgList, sysinfo,
  SpeedBar, registration, ComObj, Ole2, RxGIF, Grids, DBGrids, Registry;
...
uses untSobre, untCadInsu, untCadServ, untParam, untDadosGerais,
  ...
  untEditAcomp, untInsCrono, untBackup, untRestore, untImpInsCro;
...
begin
   ...
   AboutBox.Copyright.Caption := 'Copyright © 1999 by ' + NomeAutor;
   ...
   frmSobreMicro.Label2.Caption := 'Copyright © 1999 by ' + NomeAutor;
...
procedure TfrmMain.Restaurabackup1Click(Sender: TObject);
begin
  Fechar1Click(Sender);
